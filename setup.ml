...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2a356f6b3a1844cea8f79b81ab0a8c05) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "HardCamlExamples";
                      lib_findlib_name = Some "app";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "HardCaml Examples documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "HardCamlExamplesApp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "<\012l\230\254s\229\171\233'\211\198\140[\019\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
