...
(* OASIS_START *)
(* DO NOT EDIT (digest: ccb9bce44f44031dfc48c7ef3ac7acac) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Web_worker"; "Appjs"; "Appww"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "HardCamlFramework";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "-N_\028y\235c%\223\178\192\228\222\225\2162";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
