...
(* OASIS_START *)
(* DO NOT EDIT (digest: 89a174fd64b345f94e39624a409987ae) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-examples";
          synopsis = "HardCaml Examples";
          description =
            Some
              [
                 OASISText.Para
                   "A few simple HardCaml design examples along with a generic framework for running them to produce netlists and simulations."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Framework"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-framework";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "HardCamlExamples";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "HardCamlFramework"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-examples";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "HardCamlFrameworkConsole";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Omd_term"; "App"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "HardCamlFramework";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build javascript frontend";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "HardCamlFrameworkJS";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlExamples";
                           FindlibPackage ("hardcaml.js", None);
                           FindlibPackage ("omd", None);
                           FindlibPackage ("str", None);
                   ...
                   {
                      lib_modules =
                        ["Web_worker"; "Message"; "Appmain"; "Appww"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "HardCamlFramework";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlFrameworkConsole";
                           InternalLibrary "HardCamlExamples"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = true; exec_main_is = "hcsort.ml"});
               Executable
                 ({
                     cs_name = "hcmul";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcmul.ml"});
               Executable
                 ({
                     cs_name = "hclfsr";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hclfsr.ml"});
               Executable
                 ({
                     cs_name = "hcprefix";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcprefix.ml"});
               Executable
                 ({
                     cs_name = "hcrac";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcrac.ml"});
               Executable
                 ({
                     cs_name = "hccordic";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hccordic.ml"});
               Executable
                 ({
                     cs_name = "hcjssort";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlFrameworkJS";
                           InternalLibrary "HardCamlExamples";
                           FindlibPackage ("js_of_ocaml", None);
                           FindlibPackage ("js_of_ocaml.syntax", None)
                        ];
                   ...
                   {exec_custom = true; exec_main_is = "hcjssort.ml"});
               Executable
                 ({
                     cs_name = "hcwwsort";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcwwsort.ml"});
               Executable
                 ({
                     cs_name = "hcjscordic";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcjscordic.ml"});
               Executable
                 ({
                     cs_name = "hcwwcordic";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcwwcordic.ml"});
               Executable
                 ({
                     cs_name = "hcjslfsr";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcjslfsr.ml"});
               Executable
                 ({
                     cs_name = "hcwwlfsr";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcwwlfsr.ml"});
               Executable
                 ({
                     cs_name = "hcjsmul";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcjsmul.ml"});
               Executable
                 ({
                     cs_name = "hcwwmul";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcwwmul.ml"});
               Executable
                 ({
                     cs_name = "hcjsprefix";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcjsprefix.ml"});
               Executable
                 ({
                     cs_name = "hcwwprefix";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcwwprefix.ml"});
               Executable
                 ({
                     cs_name = "hcjsrac";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcjsrac.ml"});
               Executable
                 ({
                     cs_name = "hcwwrac";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcwwrac.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-examples.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-examples";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "'\194\250L\161\230\195\156-\011;\224{g\194\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
